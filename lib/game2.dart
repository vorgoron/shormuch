...
class GameScreen2 extends StatefulWidget {
  ...
  List<List<List<List<Cell>>>> AllLevels = List.of([
    ...
    List.of([
      List.of([
        ...
        List.of([Cell(8, "о"), Cell(1, "с"), Cell(1, "я"), Cell(1, "ы"),Cell(6, "э"),Cell(3, "р"),]),
        List.of([Cell(8, "ж"), Cell(1, "ь"), Cell(1, "ъ"), Cell(1, "л"),Cell(6, "ш"),Cell(3, "т"),]),
        List.of([Cell(8, "г"), Cell(1, "к"), Cell(1, "о"), Cell(1, "н"),Cell(6, "ъ"),Cell(6, "я"),]),
        List.of([Cell(8, "а"), Cell(8, "и"), Cell(4, "с"), Cell(6, "н"),Cell(6, "о"),Cell(6, "с"),]),
        List.of([Cell(8, "р"), Cell(8, "ч"), Cell(4, "и"), Cell(4, "н"),Cell(6, "к"),Cell(6, "ь"),]),
      ]),List.of([
        List.of([Cell(5, "ӵ"), Cell(3, "е"), Cell(3, "т"),Cell(3, "н"),Cell(3, "и"),Cell(3, "м"),]),
        List.of([Cell(5, "о"), Cell(3, "м"), Cell(3, "д"), Cell(7, "я"),Cell(7, "с"),Cell(7, "ь"),]),
        List.of([Cell(5, "ш"), Cell(5, "а"), Cell(3, "о"), Cell(7, "ъ"),Cell(7, "о"),Cell(7, "к"),]),
        List.of([Cell(5, "с"), Cell(5, "т"), Cell(3, "т"), Cell(7, "р"),Cell(7, "н"),Cell(1, "ы"),]),
        List.of([Cell(5, "к"), Cell(5, "о"), Cell(5, "н"), Cell(7, "ы"),Cell(1, "н"),Cell(1, "ь"),]),
        List.of([Cell(7, "ш"), Cell(7, "у"), Cell(7, "л"), Cell(7, "д"),Cell(1, "у"),Cell(1, "п"),]),
      ]),List.of([
        List.of([Cell(9, "л"), Cell(9, "ӥ"), Cell(9, "я"),Cell(9, "л"),Cell(9, "б"),Cell(9, "и"),]),
        List.of([Cell(1, "л"), Cell(1, "ы"), Cell(1, "м"), Cell(9, "г"),Cell(9, "у"),Cell(7, "л"),]),
        List.of([Cell(6, "г"), Cell(1, "п"), Cell(1, "ы"), Cell(3, "е"),Cell(3, "ч"),Cell(7, "у"),]),
        List.of([Cell(6, "у"), Cell(1, "о"), Cell(1, "г"), Cell(3, "р"),Cell(3, "г"),Cell(7, "д"),]),
  ...
  List<String> AllLevelwords = List.of([
    ...
    "ӵошатскон","тодметним","ним","шулдыръяськон","коӵо","лӥялгуби",
